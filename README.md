...
This repository contains the supplementary materials associated with the paper titled **"Intelligent Agents for Software Engineering: A Systematic Literature Review"**. The paper provides a comprehensive examination of the application of intelligent agents in the field of software engineering, drawing on a total of 338 research papers sourced from leading conferences and journals, including **ICSE**, **FSE**, **ASE**, **ISSTA**, and **arXiv**.
